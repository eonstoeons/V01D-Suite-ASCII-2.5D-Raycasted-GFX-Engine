...
12 fully-preserved apps (src folder), FOUR real‑time and first-person ASCII, DDS raycasted 2.5D GFX engines - all with infinite procedural generation (Previous Version Archive folder) 

Includes an IDE, coding tool,
